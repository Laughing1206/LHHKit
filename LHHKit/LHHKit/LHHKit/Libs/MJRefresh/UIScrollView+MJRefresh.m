...
- (MJRefreshLegendHeader *)addShowBgImageLegendHeaderWithRefreshingBlock:(void (^)(void))block dateKey:(NSString *)dateKey
{
	MJRefreshLegendHeader *header = [self addLegendHeader];
	header.refreshingBlock = block;
	header.dateKey = dateKey;
...
{
	return [self addShowBgImageLegendHeaderWithRefreshingBlock:block dateKey:nil];
}
