...
/** Creates, starts, and returns an asynchronous, block-backed URL connection
 ...
 @return New and running NSURLConnection with the specified properties.
  request The URL request to load.
  success A code block that acts on instances of NSURLResponse and NSData in the event of a successful connection.
  failure A code block that acts on instances of NSURLResponse and NSError in the event of a failed connection.
 */
...
/** Returns an initialized URL connection with the specified completion handler.
 ...
 @return Newly initialized NSURLConnection with the specified properties.
  request The URL request to load.
  block A code block that acts on instances of NSURLResponse and NSData in the event of a successful connection.
 */
