...
FOUNDATION_EXPORT NSInteger const DefaultVisibleCount;
FOUNDATION_EXPORT CGFloat   const DefaultArrowButtonWidth;

#import <UIKit/UIKit.h>

@protocol ScrollPageTopViewDelegate;
@interface ScrollPageTopView : UIView<UIScrollViewDelegate>

@property (nonatomic, strong) UIScrollView * bodyScrollView;
@property (nonatomic, weak) id<ScrollPageTopViewDelegate> delegate;
...
@protocol ScrollPageTopViewDelegate <NSObject>
@required
- (NSInteger)numberOfPagers:(ScrollPageTopView *)view;
- (UIViewController *)pagerViewOfPagers:(ScrollPageTopView *)view indexOfPagers:(NSInteger)number;
