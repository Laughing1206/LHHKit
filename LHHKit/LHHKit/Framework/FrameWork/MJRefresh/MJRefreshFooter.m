...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        // 初始化文字
        [self setTitle:@"查看更多" forState:MJRefreshFooterStateIdle];
        [self setTitle:@"正在加载更多的数据..." forState:MJRefreshFooterStateRefreshing];
        [self setTitle:@"没有更多了" forState:MJRefreshFooterStateNoMoreData];
    }
    return self;
}
