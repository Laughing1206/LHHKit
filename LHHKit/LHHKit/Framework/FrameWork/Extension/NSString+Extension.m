...
{
    return [[[NSData alloc]initWithBase64EncodedString:self options:0] base64DecodedString];
}
...
+ (NSString *)getStringWithType:(DATE_TYPE)type formatter:(NSString *)str
{
    if (str && str.length)
    {
        ...
        switch (type) {
            case DATE_TYPE_YMDHMSW:[formatter setDateFormat:@"yyyy-MM-dd HH:mm:ss EEEE"];break;
            case DATE_TYPE_YMDHMS:[formatter setDateFormat:@"yyyy-MM-dd HH:mm:ss"];break;
            case DATE_TYPE_YMDHM:[formatter setDateFormat:@"yyyy-MM-dd HH:mm"];break;
            case DATE_TYPE_YMD:[formatter setDateFormat:@"yyyy-MM-dd"];break;
            case DATE_TYPE_YM:[formatter setDateFormat:@"yyyy-MM"];break;
            case DATE_TYPE_MD:[formatter setDateFormat:@"MM-dd"];break;
            case DATE_TYPE_HMS:[formatter setDateFormat:@"HH:mm:ss"];break;
            case DATE_TYPE_HM:[formatter setDateFormat:@"HH:mm"];break;
            case DATE_TYPE_MS:[formatter setDateFormat:@"mm:ss"];break;
            default:[formatter setDateFormat:@"yyyy-MM-dd HH:mm:ss"];break;
        }
...
- (NSString *)APPImgURL
{
    ...
    {
        return [NSString stringWithFormat:@"%@%@" , [AppConfig sharedAppConfig].kAppServerAPIURL,self];
    }
    return self;
}
