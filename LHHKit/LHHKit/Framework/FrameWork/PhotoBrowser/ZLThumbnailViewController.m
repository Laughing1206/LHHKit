...
- (void)initNavBtn
{
    ...
    [nav.viewControllers.firstObject.navigationItem.backBarButtonItem setTitleTextAttributes:@{NSForegroundColorAttributeName:[UIColor whiteColor],
                                                                                               NSFontAttributeName: [UIFont systemFontOfSize:16]
                                                                                               } forState:UIControlStateNormal];
    [nav.viewControllers.firstObject.navigationItem.backBarButtonItem setTintColor:[UIColor whiteColor]];
